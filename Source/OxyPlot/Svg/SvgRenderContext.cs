...
namespace OxyPlot
{
    ...
    public class SvgRenderContext : RenderContextBase, IDisposable
    {
        ...
        public SvgRenderContext(Stream s, double width, double height, bool isDocument, ITextMeasurer textMeasurer, OxyColor background)
        {
            ...
            this.TextArranger = new TextArranger(textMeasurer);
        ...
        /// <summary>
        /// Determines the font descent for the given font.
        /// </summary>
        /// <param name="fontFamily">The font family.</param>
        /// <param name="fontSize">Size of the font.</param>
        /// <param name="fontWeight">The font weight.</param>
        /// <returns>A positive value, that distance between the baseline and the bottom of any rendered text.</returns>
        public virtual double GetFontDescent(string fontFamily, double fontSize, double fontWeight)
        {
            var lineHeight = this.MeasureText("Ag", fontFamily, fontSize, fontWeight).Height;
            var descentRatioGuess = 0.28;
            return lineHeight * descentRatioGuess;
        }
