...
namespace OxyPlot.Rendering
{
    ...
    public class TextArranger
    {
            ...
            out ScreenPoint[] linePositions)
        {
            ...
            bool useBaslineOffset = targetVerticalAlignment == TextVerticalAlignment.Baseline;
            if (useBaslineOffset)
            {
        ...
        {
            var offset =
                horizontalAlignment == HorizontalAlignment.Left ? -0.5
                : horizontalAlignment == HorizontalAlignment.Center ? 0.0
                : horizontalAlignment == HorizontalAlignment.Right ? 0.5
        ...
        {
            var offset =
                verticalAlignment == VerticalAlignment.Top ? 0.5
                : verticalAlignment == VerticalAlignment.Middle ? 0.0
                : verticalAlignment == VerticalAlignment.Bottom ? -0.5
